...
class CallTypes():
    ...
    SendMessage = CallTypeMeta('SendMessage')
    AddChannel = CallTypeMeta('AddChannel')
    Info = CallTypeMeta('Info')
    AddFile = CallTypeMeta('AddFile', 'yes')
    Back = CallTypeMeta('Back')

    ChannelName = CallTypeMeta('ChannelName', 'id__int')
    ButtonName = CallTypeMeta('ButtonName', 'info_id__int','id__int')

    Posts = CallTypeMeta('Posts')
    Channels = CallTypeMeta('Channels')
    Nothing = CallTypeMeta('Nothing')
    DeletePost = CallTypeMeta('DeletePost', 'id__int')
    Active = CallTypeMeta('Active', 'id__int')
    SeeVoted = CallTypeMeta('SeeVoted', 'id__int')
